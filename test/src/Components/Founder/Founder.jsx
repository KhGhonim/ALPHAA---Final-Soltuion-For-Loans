// @ts-ignore
import second from "../../assets/Pawan-panjabi-e1724242619180.png";
// @ts-ignore
...
export default function Founder() {
  return (
    <section className="flex flex-col items-center p-16 bg-white space-y-8 lg:h-dvh">
      ...
      <img
        src={second}
        alt="Mr. Khaled Ghonimi"
        className="rounded-lg w-80 h-full max-md:w-80 object-cover"
      />
      <div className="text-center border-b-4 border-orange-400 p-3 rounded-xl w-52 max-md:w-72">
        <h3 className=" text-lg font-bold text-primary">Mr. Khaled Ghonim</h3>
